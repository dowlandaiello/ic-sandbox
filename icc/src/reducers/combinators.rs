    ...
    fn test_reduce() {
        let cases = [
            ...
            (
                ...
                vec!["Dup[@2](a#0, Constr[@1](d#0, @2#1, Dup[@3](b#0, @1#2, Constr[@0](c#0, @2#2, @3#2)#2)#1)#1, @0#1)"],
            ),
            (
                "Dup[@1](a, b) >< Constr[@2](d, c)",
                vec!["Constr[@2](a#0, Dup[@1](d#0, @2#1, Constr[@3](b#0, @1#2, Dup[@0](c#0, @2#2, @3#2)#2)#1)#1, @0#1)"],
            ),
        ];
